...
def main():
    if options.conf:
        ...
        print '        "comp":"Memory"},'
        print '"rule":{"name":"memory_free_percent_threshold",'
        print '        "input":"memory_free_percent",'
        print '        "operator":"SWDIAG_RULE_LESS_THAN_N",'
        print '        "n":', diag_memory_conf.free_percent_threshold, ','
        print '        "comp":"Memory"},'
        print '"rule":{"name":"memory_free_percent_threshold_time",'
        print '        "input":"memory_free_percent_threshold",'
        ...
        print '        "comp":"Memory"},'
        print '"rule":{"name":"memory_swap_inuse_threshold",'
        print '        "input":"memory_swap_inuse",'
        print '        "operator":"SWDIAG_RULE_GREATER_THAN_N",'
        print '        "n":',diag_memory_conf.swap_inuse_threshold, ','
        print '        "comp":"Memory"},'
        print '"rule":{"name":"memory_swap_inuse_threshold_time",'
        print '        "input":"memory_swap_inuse_threshold",'
